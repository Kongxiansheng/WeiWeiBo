...
class HomeAction extends AdministratorAction
{
    ...
    public function statistics()
    {
        ...
        //     L('PUBLIC_COPYRIGHT') => '<a href="http://www.learnitbbs.cn" target="_blank">'.L('PUBLIC_COMPANY').'</a>',
        // );
        $statistics[L('PUBLIC_DEV_TEAM')] = array(
            L('PUBLIC_COPYRIGHT') => '<a href="http://www.learnitbbs.cn" target="_blank">'.'微微博开发团队'.'</a>',
        );
